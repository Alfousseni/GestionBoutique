...
include $_SERVER['DOCUMENT_ROOT'].'/gestionstock-master/utility/main.inc.php';
...
include_once 'View/include/layout.head.tpl.php';
...
if (isset($_GET['page'])) {
    ...
    switch ($page) {
        ...
        case "deconnexion":
            ...
            break;
        case "ajout-produit":
            include_once "View/include/session_test.php";
            if(isset($_POST['action'])){
                $produitController = new ProduitController();
                $response = $produitController->ajoutAction($_POST);
                header('Location:'.$response);
            }
            include_once 'View/ajout-produit.php';
            break;
        ...
        case "liste-produit":
            ...
            include_once 'View/liste-produit.php';
            break;
        ...
        case "modify-produit":
            ...
            include_once 'View/modify-produit.php';
            break;
        ...
        case "ajout-client":
            ...
            include_once 'View/ajout-client.php';
            break;
        case "liste-client":
            include_once "View/include/session_test.php";
            $clientController = new ClientController();
            $response = $clientController->listeAction($_GET['type']);
            include_once 'View/liste-client.php';
            break;
        ...
        case "modify-client":
            ...
            $response = $produitController->getAction($_GET['id']);
            include_once 'View/modify-client.php';
            break;
        ...
        case "ajout-commande":
            ...
            include_once 'View/ajout-commande.php';
            break;
        ...
        case "liste-commande":
            ...
            include_once 'View/liste-commande.php';
            break;

        //user
        case "ajout-user":
            include_once "View/include/session_admin.php";
            $user = new UserController();
            if(isset($_POST['action'])){
                $response = $user->ajoutAction($_POST);
                header('Location:'.$response);
            }
            include_once 'View/ajout-user.php';
            break;
        case "liste-user":
            include_once "View/include/session_admin.php";
            $user = new UserController();
            $response = $user->listeAction($_GET['type']);
            include_once 'View/liste-user.php';
            break;
        ...
        case "modify-user":
            ...
            include_once 'View/modify-user.php';
            break;
        //user
        default:
            include_once 'View/error/error404.tpl.php';
            break;
    }
}
else {
...
include_once 'View/include/layout.foot.tpl.php';
ob_end_flush();
